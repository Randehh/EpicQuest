...
public class EpicSystem {
	...
	public static void setPlayerList(List<EpicPlayer> newPlayerList) {
		playerList = newPlayerList;
	}
	public static void setSignList(List<EpicSign> newSignList) {
		signList = newSignList;
	}
	public static void setSaveTime(int time) {
		saveTime = time;
	}
	public static void setBlockList(ArrayList<Vector> newBlockList) {
		blockedList = newBlockList;
	}
	public static void setMaxPartySize(int size) {
		maxPartySize = size;
	}
	public static void setUsePermissions(boolean use) {
		usePermissions = use;
	}
	public static void setUseBook(boolean use) {
		useBook = use;
	}
	public static void setUseHeroes(boolean use) {
		useHeroes = use;
	}
	public static void setUseCitizens(boolean use) {
		useCitizens = use;
	}
	public static void setUseBarAPI(boolean use) {
		useBarAPI = use;
	}
	public static void setEnabledAnnouncer(boolean enabled) {
		enabledAnnouncer = enabled;
	}
	public static void setEnabledMoneyRewards(boolean enabled) {
		enabledMoneyRewards = enabled;
	}
	...
	public static void modifyTime(int newTime) {
		time += newTime;
	}
	public static void modifySaveTime(int newSaveTime) {
	...
	public static EpicPlayer getEpicPlayer(UUID id) {
		...
		if (playerList.get(playerList.size() - 1).getPlayerID().equals(id)) {
	...
	public static List<String> getLeaderboard() {
		// TODO: Create self rearranging List so that index 0 will have
		// EpicPlayer with greatest Quests completed and index (index.length -
		// 1) with lowest
