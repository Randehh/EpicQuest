...
public class EpicQuestTask {
	...
	public static enum TaskTypes {
		CRAFT_ITEM, DESTROY_BLOCK, ENCHANT_ITEM, GO_TO, KILL_MOB, KILL_PLAYER, KILL_ANY_PLAYER, KILL_ANY_MOB, KILL_MOB_BY_NAME, LEVEL_UP, PLACE_BLOCK, SMELT_ITEM, TAME_MOB, TALK_TO_VILLAGER, REPAIR_ITEM, CLICK_BLOCK, EXECUTE_COMMAND
	}
	...
	public EpicQuestTask(TaskTypes taskType, String taskID, int taskGoal,
		...
		if (taskType == TaskTypes.EXECUTE_COMMAND) {
			...
			if (command.contains(" "))
				command = taskID.split(" ")[0];
			EpicMain.getInstance().getCommand(command)
					.setExecutor(EpicMain.getInstance().commandListener);
		}
	}
	...
	public void ProgressTask(int amount, EpicPlayer player) {
		...
		if (player != null && SendText()) {
			if (EpicSystem.useBarAPI()) {
				BarAPI.setMessage(player.getPlayer(),
						getPlayerTaskProgressText(), (float) getTaskProgress()
								/ getTaskGoal());
			} else {
				player.getPlayer().sendMessage(getPlayerTaskProgressText());
			}

			if (IsComplete() && quest.getQuestAutoComplete()
					&& quest.isCompleted()) {
				quest.completeQuest();
			}
		}
	...
	public String getPlayerTaskProgressText() {
		...
		if (IsComplete()) {
			switch (questtype) {
				case CRAFT_ITEM :
					return ChatColor.GREEN + "Crafted " + taskmax + " "
							+ taskID.toLowerCase().replace("_", " ");
				case DESTROY_BLOCK :
					return ChatColor.GREEN + "Destroyed " + taskmax + " "
							+ taskID.toLowerCase().replace("_", " ");
				case ENCHANT_ITEM :
					return ChatColor.GREEN + "Enchanted " + taskmax + " "
							+ taskID.toLowerCase().replace("_", " ");
				case GO_TO :
				...
				case KILL_MOB :
					return ChatColor.GREEN + "Killed " + taskmax + " "
							+ taskID.toLowerCase().replace("_", " ") + "s";
				case KILL_PLAYER :
					return ChatColor.GREEN + "Killed "
							+ taskID.toLowerCase().replace("_", " ") + " "
							+ taskmax + " times";
				case LEVEL_UP :
					return ChatColor.GREEN + "Leveled up " + taskmax + " times";
				case PLACE_BLOCK :
					return ChatColor.GREEN + "Placed " + taskmax + " "
							+ taskID.toLowerCase().replace("_", " ");
				case SMELT_ITEM :
					return ChatColor.GREEN + "Smelted " + taskmax + " "
							+ taskID.toLowerCase().replace("_", " ");
				case TALK_TO_VILLAGER :
					return ChatColor.GREEN + "Talked to "
							+ taskID.toLowerCase().replace("_", " ");
				case TAME_MOB :
					return ChatColor.GREEN + "Tamed " + taskmax + " "
							+ taskID.toLowerCase().replace("_", " ");
				case KILL_ANY_MOB :
				...
				case REPAIR_ITEM :
					return ChatColor.GREEN + "Repaired " + taskmax + " "
							+ taskID.toLowerCase().replace("_", " ");
				case CLICK_BLOCK :
			...
			switch (questtype) {
				case CRAFT_ITEM :
					return ChatColor.RED + "Craft " + taskprogress + "/"
							+ taskmax + " "
							+ taskID.toLowerCase().replace("_", " ");
				case DESTROY_BLOCK :
					return ChatColor.RED + "Destroy " + taskprogress + "/"
							+ taskmax + " "
							+ taskID.toLowerCase().replace("_", " ");
				case ENCHANT_ITEM :
					return ChatColor.RED + "Enchant " + taskprogress + "/"
							+ taskmax + " "
							+ taskID.toLowerCase().replace("_", " ");
				case GO_TO :
					return ChatColor.RED + "Go to " + taskID;
				case KILL_ANY_PLAYER :
					return ChatColor.RED + "Kill " + taskprogress + "/"
							+ taskmax + " players";
				case KILL_MOB :
					return ChatColor.RED + "Kill " + taskprogress + "/"
							+ taskmax + " "
							+ taskID.toLowerCase().replace("_", " ") + "s";
				case KILL_PLAYER :
					return ChatColor.RED + "Kill "
							+ taskID.toLowerCase().replace("_", " ") + " "
							+ taskprogress + "/" + taskmax + " times";
				case LEVEL_UP :
					return ChatColor.RED + "Level up " + taskprogress + "/"
							+ taskmax + " times";
				case PLACE_BLOCK :
					return ChatColor.RED + "Place " + taskprogress + "/"
							+ taskmax + " "
							+ taskID.toLowerCase().replace("_", " ");
				case SMELT_ITEM :
					return ChatColor.RED + "Smelt " + taskprogress + "/"
							+ taskmax + " "
							+ taskID.toLowerCase().replace("_", " ");
				case TALK_TO_VILLAGER :
					return ChatColor.RED + "Talk to "
							+ taskID.toLowerCase().replace("_", " ");
				case TAME_MOB :
					return ChatColor.RED + "Tame " + taskprogress + "/"
							+ taskmax + " "
							+ taskID.toLowerCase().replace("_", " ");
				case KILL_ANY_MOB :
					return ChatColor.RED + "Kill " + taskprogress + "/"
				...
				case KILL_MOB_BY_NAME :
					return ChatColor.RED + "Kill " + taskprogress + "/"
							+ taskmax + " " + taskID;
				case REPAIR_ITEM :
					return ChatColor.RED + "Repair " + taskprogress + "/"
							+ taskmax + " "
							+ taskID.toLowerCase().replace("_", " ");
				case CLICK_BLOCK :
	...
	public static TaskTypes getTaskTypeFromText(String text) {
		...
		if (text.equalsIgnoreCase("killplayer"))
			return TaskTypes.KILL_PLAYER;
		if (text.equalsIgnoreCase("killanyplayer"))
